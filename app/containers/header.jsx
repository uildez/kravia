...
export const Header = () => {
  return (
    <div className='relative flex flex-col w-full items-start justify-center min-h-[60vh] gap-8 pt-32 my-12 lg:my-20 px-8 lg:px-20 2xl:px-40'>
      ...
      <div className='absolute min-w-full min-h-screen z-0 overflow-hidden right-0 max-w-[1920] mt-[70px] lg:mt-[100px]'>
        <video
          width="900"
          height="900"
          autoPlay
          ...
          preload="none" className="min-w-[130%] lg:min-w-full lg:min-h-screen lg:-translate-y-12 -translate-x-20 lg:translate-x-0"
        >
