    ...
    <div id='sobre-nos' className="flex flex-col-reverse lg:flex-row bg-[#DDDDDD] w-full items-stretch justify-center my-4">
      <div className="flex flex-col justify-center h-auto gap-8 px-6 lg:pl-20 2xl:pl-40 lg:pr-32 py-12 lg:py-20 w-full lg:w-1/2">
        ...
        <p className="font-aeonik text-lg lg:text-xl leading-relaxed">
          Somos credenciados pelos maiores players globais de tecnologia, como Cisco e AWS Academy. Mas o que nos torna únicos vai além da chancela: a KRAVIA detém capital intelectual exclusivo em treinamentos avançados, que poucos centros no mundo têm capacidade de oferecer.<br /><br />
